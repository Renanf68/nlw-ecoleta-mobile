    ...
    <React.Fragment>
      <View style={styles.container}>
        ...
        <View style={styles.mapContainer}>
          {coordinates[0] === 0 ? (
            <Text style={styles.description}>Carregando mapa...</Text>
          ) : (
            <MapView
              style={styles.map}
              loadingEnabled={coordinates[0] === 0}
              initialRegion={{
                latitude: coordinates[0], //-8.0507758,
                longitude: coordinates[1], //-34.9395427,
                latitudeDelta: 0.01,
                longitudeDelta: 0.01,
              }}
            >
      ...
      <View style={styles.itemsContainer}>
        <Text style={styles.itemsDescription}>
          Filtrar por tipo de item coletado.
        </Text>
        <ScrollView
          horizontal
